...
if abs(joystick_mean_y + str2double(hardware.inputs.settings.joystick_y_bias)) > hardware.inputs.settings.joystick_sensitivity * 50 |...
    abs(joystick_mean_x + str2double(hardware.inputs.settings.joystick_x_bias)) > hardware.inputs.settings.joystick_sensitivity * 50
