...
task_checks = table([repmat(0, 1, length(parameters.task_checks.requirements))'],...
    ...
    {'monkey_fixated_on_cross';'monkey_holding_joystick_still';'monkey_touching_joystick';'monkey_bidding_activity';'monkey_bid_stabilised';'monkey_bid_targeted';'monkey_bid_past_bounds'},...
    'VariableNames',{'Status','Requirement','Description'},...
    'RowNames',{'fixation';'joystick_centered';'touch_joystick';'no_bid_activity';'stabilised_offer';'targeted_offer';'unbounded_bid'});
