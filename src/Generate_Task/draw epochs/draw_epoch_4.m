%function to draw the fourth epoch- the start of the monkey bidding
%takes the bidspace info and textures generated before the trials and also
%the trial selected fractal
%draws a bidding bar over the bidspace
function [] = draw_epoch_4(trial_fractal, trial_fractal_info, parameters, bidspace_texture, bidspace_bounding_box, bidspace_info, screen_info, task_window)
