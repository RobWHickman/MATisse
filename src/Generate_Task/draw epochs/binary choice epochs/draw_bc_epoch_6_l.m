...
Screen('FillRect', task_window, [hardware.outputs.screen_info.white/2], [hardware.outputs.screen_info.width/2, 0, hardware.outputs.screen_info.width, hardware.outputs.screen_info.height]);
